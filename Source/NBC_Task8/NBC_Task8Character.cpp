...
ANBC_Task8Character::ANBC_Task8Character()
{
...
void ANBC_Task8Character::NotifyControllerChanged()
{
...
void ANBC_Task8Character::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ANBC_Task8Character::Move);
...
void ANBC_Task8Character::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ANBC_Task8Character::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
